...
public class RecordManagerTest {
    ...
    public void givenAnEmptyRecord_whenSave_thenRecordsSizeIsOne() {
        // given:
        RecordManager recordManager = new RecordManager(10, "test1.txt");
    ...
    public void givenAnFullRecord_whenSave_thenRecordsSizeIsNotChanged() {
        // given:
        RecordManager recordManager = new RecordManager(2, "test2.txt");
    ...
    public void givenAnExistentRecord_whenSave_thenRecordIsPersisted() {
        // given:
        RecordManager recordManager = new RecordManager(2, "test3.txt");

        Record juan = new Record("Juan", 80);
        recordManager.save(juan);

        // when:
        RecordManager recordManager2 = new RecordManager(2, "test3.txt");
        Record mario = new Record("Mario", 70);
    ...
    public void givenAnEmptyName_whenSave_thenThrowAnException() {
        // given:
        RecordManager recordManager = new RecordManager(2, "test4.txt");
    ...
    public void verifySorting() {
        // given:
        RecordManager recordManager = new RecordManager(5, "test5.txt");
